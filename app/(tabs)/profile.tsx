    ...
    >
      <View className="flex-row items-center flex-1">
        ...
        <View className="flex-1">
          ...
          {subtitle && <Text className="text-muted-foreground text-sm font-anuphan">{subtitle}</Text>}
        </View>
      </View>
      {rightElement || (showChevron && (
        <ChevronRightIcon size={20} color={colorScheme === 'dark' ? THEME.dark.muted : THEME.light.muted} />
      ))}
    </TouchableOpacity>
  );
      ...
      >
        ...
        <View className="p-12">
          <View className="items-center">
            {/* Avatar */}
            <View className={
              cn('w-20 h-20 rounded-full items-center justify-center mb-3',
            ...
            <View className="flex-row items-center bg-primary/10 px-3 py-1 rounded-lg">
              <StarIcon size={16} color={colorScheme === 'dark' ? THEME.dark.primary : THEME.light.primary} />
        ...
        <View className="px-4">
          ...
          <View className="mb-4">
            <View className="flex-row items-center mb-2 ml-1">
              <UserIcon size={20} color={colorScheme === 'dark' ? THEME.dark.primary : THEME.light.primary} />
              <Text className="ml-2 font-anuphan-bold text-lg">ข้อมูลส่วนตัว</Text>
            </View>

            <SettingItem
              icon={<MailIcon size={22} color={colorScheme === 'dark' ? THEME.dark.primary : THEME.light.primary} />}
              title="อีเมล"
            ...
            <SettingItem
              icon={<PhoneIcon size={22} color={colorScheme === 'dark' ? THEME.dark.primary : THEME.light.primary} />}
              title="เบอร์โทรศัพท์"
          ...
          <View className="mb-4">
            <View className="flex-row items-center mb-2 ml-1">
              <Settings2Icon size={20} color={colorScheme === 'dark' ? THEME.dark.primary : THEME.light.primary} />
            ...
            <SettingItem
              ...
              rightElement={
                <Switch
                  ...
                  trackColor={{ false: '#e5e7eb', true: colorScheme === 'dark' ? THEME.dark.primary : THEME.light.primary }}
          ...
          <View className="mb-4">
            <View className="flex-row items-center mb-2 ml-1">
              <ShieldIcon size={20} color={colorScheme === 'dark' ? THEME.dark.primary : THEME.light.primary} />

...
import { MapMarker, CustomMarker } from './MapMarker';
...
export function InteractiveMap({ 
  ...
  const handleMapPress = async (event: any) => {
    ...
    try {
      ...
      if (location) {
        ...
        Alert.alert(
          'เพิ่มหมุดสำเร็จ',
          `เพิ่มหมุดที่ ${location.name} แล้ว`,
          [{ text: 'ตกลง' }]
        );
      } else {
        ...
        Alert.alert(
          'เพิ่มหมุดสำเร็จ',
          'เพิ่มหมุดที่ตำแหน่งที่เลือกแล้ว',
          [{ text: 'ตกลง' }]
        );
      }
    } catch (error) {
  ...
  const handleAddMarker = () => {
    if (selectedLocation) {
      ...
      Alert.alert(
        'เพิ่มหมุดสำเร็จ',
        `เพิ่มหมุดที่ ${selectedLocation.name} แล้ว`,
        [{ text: 'ตกลง' }]
      );
    }
  };
  ...
  const handleClearMarkers = () => {
    Alert.alert(
      'ลบหมุดทั้งหมด',
      'คุณต้องการลบหมุดทั้งหมดหรือไม่?',
      [

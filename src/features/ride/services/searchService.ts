...
export class SearchService {
  ...
  async searchPlaces(request: SearchRequest): Promise<LocationResult[]> {
    try {
      ...
      return response.data.data.places.map(
  ...
  private getFallbackSearchResults(query: string): LocationResult[] {
    const fallbackData: LocationResult[] = [
      {
        ...
        coordinates: [100.5395, 13.7472] as [number, number],
        placeType: 'poi',
      },
      {
        id: 'fallback-2',
        ...
        coordinates: [100.5347, 13.7463] as [number, number],
        placeType: 'poi',
      },
      {
        id: 'fallback-3',
        ...
        coordinates: [100.5605, 13.7307] as [number, number],
        placeType: 'poi',
      },
      {
        id: 'fallback-4',
        ...
        coordinates: [100.5495, 13.7998] as [number, number],
        placeType: 'poi',
      },
      {
        id: 'fallback-5',
        ...
        coordinates: [100.5408, 13.7307] as [number, number],
        placeType: 'poi',
      },
      {
        id: 'fallback-6',
        ...
        coordinates: [100.4955, 13.74964] as [number, number],
        placeType: 'temple',
      },
      {
        id: 'fallback-7',
        name: 'วัดโพธิ์ (Wat Pho)',
        address: 'พระนคร, กรุงเทพมหานคร',
        coordinates: [100.4927, 13.7468] as [number, number],
        placeType: 'temple',
      },
      {
        id: 'fallback-8',
        name: 'วัดอรุณราชวราราม (Wat Arun)',
        address: 'ธนบุรี, กรุงเทพมหานคร',
        coordinates: [100.4889, 13.7437] as [number, number],
        placeType: 'temple',
      },
      {
        id: 'fallback-9',
        name: 'วัดพระธรรมราช (Wat Phra Si Rattana Mahathat)',
        address: 'พระนคร, กรุงเทพมหานคร',
        coordinates: [100.4856, 13.7408] as [number, number],
        placeType: 'temple',
      },
      {
        id: 'fallback-10',
    ...
    const filteredResults = fallbackData.filter(
      (item) =>

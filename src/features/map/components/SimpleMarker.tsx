...
export function SimpleMarker({ id, coordinate, type = 'destination', onPress }: SimpleMarkerProps) {
  ...
  return (
    <Mapbox.PointAnnotation id={id} coordinate={coordinate} onSelected={onPress}>
      <View
        style={{
          width: style.size,
          height: style.size,
      ...
      >
        <Icon as={IconComponent} className={`size-${style.iconSize} text-white`} />
      </View>

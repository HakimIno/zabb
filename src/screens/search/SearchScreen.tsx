...
const RECENT_SEARCHES = [
  ...
  { id: '3', name: 'Chatuchak Weekend Market', address: 'Kamphaeng Phet 2 Road, Bangkok', type: 'market' },
];

const POPULAR_DESTINATIONS = [
  { id: '1', name: 'Suvarnabhumi Airport', address: 'Samut Prakan, Thailand', type: 'airport', distance: '45 km' },
  { id: '2', name: 'Terminal 21', address: 'Sukhumvit Road, Bangkok', type: 'shopping', distance: '8 km' },
  { id: '3', name: 'Wat Pho', address: 'Sanam Chai Road, Bangkok', type: 'temple', distance: '12 km' },
  { id: '4', name: 'Chatuchak Weekend Market', address: 'Kamphaeng Phet 2 Road, Bangkok', type: 'market', distance: '15 km' },
  { id: '5', name: 'Lumpini Park', address: 'Rama IV Road, Bangkok', type: 'park', distance: '6 km' },
  { id: '6', name: 'Asiatique', address: 'Charoenkrung Road, Bangkok', type: 'entertainment', distance: '18 km' },
];
            ...
            {QUICK_ACTIONS.map((action) => (
              ...
              >
                <View className="h-16 bg-gray-50 dark:bg-gray-900 rounded-2xl items-center justify-center border border-gray-200 dark:border-gray-800">
                  <Icon as={action.icon} className="size-6 text-gray-700 dark:text-gray-300 mb-1" />
              ...
              {RECENT_SEARCHES.map((search, index) => (
                ...
                >
                  <View className="flex-row items-center">
                    ...
                    <Icon as={ArrowLeftIcon} className="size-4 text-gray-300 dark:text-gray-600 rotate-180" />
                  </View>
                </TouchableOpacity>
              ))}
            </View>
